            ...
            <div class="widget-body">
                ...
                <?php } else { ?>
                    ...
                    <div class="row  image_upload_container">
                        <div class="form-group image_upload_container col-md-9" style="display: <?php echo ($item->news_type == "image") ? "block" : "none"; ?>">
                            <label>Görsel Seçiniz</label>
                            <input type="file" name="img_url" class="form-control ">
                        </div>    
                ...
                <a href="<?php echo base_url("news"); ?>" class="btn btn-xs btn-danger btn-outline">İptal</a>
            </form>
        </div><!-- .widget-body -->
    </div><!-- .widget -->
</div><!-- END column -->
