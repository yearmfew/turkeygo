...
<?php } else { ?>
    ...
    <table class="table table-bordered table-striped table-hover pictures_list">
        ...
        <tbody class="sortable" data-url="<?php echo base_url("tour/imageRankSetter"); ?>">
            ...
            <?php foreach($item_images as $image){ ?>
                ...
                <tr id="ord-<?php echo $image->id; ?>">
                    ...
                    <td class="w50 text-center">
                        <input
                        data-url="<?php echo base_url("tours/imageIsActiveSetter/$image->id"); ?>"
                        class="isActive"
                        type="checkbox"
                        data-size ="small"
                        data-switchery
                    ...
                    <td class="w100 text-center">
                        <input
                        data-url="<?php echo base_url("tours/isCoverSetter/$image->id/$image->tour_id"); ?>"
                        class="isCover"
                        type="checkbox"
                        data-size ="small"
                        data-switchery
                    ...
                    <td class="w100 text-center">
                        <button
                        data-url="<?php echo base_url("tours/imageDelete/$image->id/$image->tour_id"); ?>"
